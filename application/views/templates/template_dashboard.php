...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">SIPENPANIN <sup>MUHIKU</sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUser" class="collapse" aria-labelledby="headingUser" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= site_url('user'); ?>">Daftar Anggota</a>
            <a class="collapse-item" href="<?= site_url('user/add'); ?>">Tambah Anggota</a>
          </div>
        </div>
      </li>
  ...
  <!-- Page level with DataTable plugins -->
